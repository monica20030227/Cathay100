...
if st.session_state.page == "start":
    ...
    with c2:
        st.markdown("<div class='rpg-card'><h2>📚 Life100 百科</h2><p>查看不同保險的用途、保障內容、適合族群、遊戲效果與國泰官方商品連結。</p><p></p><p></p><p></p></div>", unsafe_allow_html=True)
        if st.button("📖 查看保險百科", use_container_width=True): goto("insurance")
    with c3:
        st.markdown("<div class='rpg-card'><h2>🧭 遊戲說明</h2><p>第一次使用建議先看玩法。了解身、心、財三大數值與人生規劃室的作用。</p><p></p><p></p><p></p></div>", unsafe_allow_html=True)
