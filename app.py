...
def init_state():
    defaults = {"page":"start","age":25,"health":80,"mind":80,"wealth":80,"tree":0,"game_items":[],"logs":[],"persona":"尚未生成","goal":"","last_event":None,"last_event_tag":None,"previous_page":"start","defense_notice":"","pending_planning":False,"initial_budget":30,"initial_planning_done":False,"shop_mode":"normal", "history":{"age":[25],"health":[80],"mind":[80],"wealth":[80]}}
...
if st.session_state.page == "start":
    ...
    if st.button("✨ 生成我的人生面板", use_container_width=True):
        ...
        # 初始化歷史軌跡第一筆數據
        st.session_state.history = {"age": [25], "health": [st.session_state.health], "mind": [st.session_state.mind], "wealth": [st.session_state.wealth]}
